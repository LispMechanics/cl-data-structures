...
(defgeneric update (container location new-value)
  (:documentation "If LOCATION is taken in the CONTAINER, update it. Returns three values: first: new CONTAINER with update LOCATION, second: t if update took place; nil otherwise, previous value."))
